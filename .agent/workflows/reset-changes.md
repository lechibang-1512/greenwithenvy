---
description: How to revert all changes made by GreenWithEnvy
---

# Reset / Revert GreenWithEnvy Changes

1. Revert all configuration changes and delete the cache:

```bash
sudo python3 ./greenwithenvy.py --reset
```
...
```bash
sudo python3 ./greenwithenvy.py --reset-sddm
```
